...
import historyImg from '../assets/graduates.webp'
...
import governanceImg from '../assets/leadership1.webp'
import ctaImg from '../assets/applications.jpeg'
import valuesImg from '../assets/slide-1.webp'
...
const styles = {
  ...
  govCardImgAlt: {
    height: 180,
    background: 'linear-gradient(135deg, #0E7BB5, #0a3a60)',
    display: 'flex',
    flexDirection: 'column',
    alignItems: 'center',
    justifyContent: 'center',
