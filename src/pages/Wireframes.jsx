...
const styles = {
  ...
  heroTag: { color: '#FFB800', fontSize: '12px', fontWeight: 700, letterSpacing: '3px', textTransform: 'uppercase', marginBottom: '12px' },
  heroTitle: { fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, marginBottom: '16px', letterSpacing: '-1px' },
  heroSub: { color: 'rgba(255,255,255,0.85)', fontSize: '17px', lineHeight: 1.8, maxWidth: '700px' },
  section: { padding: '80px 0', background: '#fff' },
  sectionTitle: { fontSize: 'clamp(24px, 3vw, 34px)', fontWeight: 700, color: '#1a1a1a', marginBottom: '12px', letterSpacing: '-0.5px' },
  sectionSub: { color: '#666', fontSize: '15px', lineHeight: 1.8, marginBottom: '40px', maxWidth: '700px' },
  deliverablesGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '20px' },
  deliverableCard: { background: '#fff', border: '1px solid #e8e8e8', borderLeft: '4px solid #0E7BB5', borderRadius: '10px', padding: '20px', display: 'flex', gap: '16px' },
  deliverableIcon: { width: '44px', height: '44px', borderRadius: '10px', background: '#e8f4fc', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  deliverableBody: { flex: 1 },
  deliverableHead: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' },
  deliverableTitle: { fontSize: '15px', fontWeight: 700, color: '#1a1a1a' },
  statusBadge: { fontSize: '11px', fontWeight: 700, color: '#fff', background: '#2ecc71', padding: '3px 10px', borderRadius: '20px' },
  deliverableDetail: { fontSize: '13px', color: '#555', lineHeight: 1.7 },
  pageGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '20px' },
  pageCard: { background: '#fff', border: '1px solid #e8e8e8', borderRadius: '10px', padding: '24px', display: 'flex', flexDirection: 'column', gap: '12px' },
  pageHeader: { display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '4px' },
  pageIconWrap: { width: '40px', height: '40px', borderRadius: '8px', background: '#e8f4fc', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  pageName: { fontSize: '16px', fontWeight: 700, color: '#1a1a1a' },
  pagePath: { fontSize: '12px', color: '#0E7BB5', fontFamily: 'monospace' },
  sectionList: { listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '6px', flex: 1 },
  sectionItem: { fontSize: '12px', color: '#555', lineHeight: 1.6, paddingLeft: '12px', position: 'relative' },
  viewBtn: { background: '#0E7BB5', color: '#fff', textDecoration: 'none', padding: '8px 16px', borderRadius: '6px', fontSize: '13px', fontWeight: 600, textAlign: 'center', marginTop: '8px' },
  apiTable: { background: '#fff', border: '1px solid #e8e8e8', borderRadius: '10px', overflow: 'hidden' },
  apiHead: { display: 'grid', gridTemplateColumns: '80px 200px 220px 1fr', background: '#1a1a1a', color: '#FFB800', padding: '14px 20px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', gap: '16px' },
  apiRow: { display: 'grid', gridTemplateColumns: '80px 200px 220px 1fr', padding: '14px 20px', gap: '16px', alignItems: 'center', borderBottom: '1px solid #f0f0f0' },
  methodBadge: { fontSize: '11px', fontWeight: 700, padding: '3px 10px', borderRadius: '4px', textAlign: 'center', letterSpacing: '0.5px' },
  apiPath: {}, apiFunc: {},
  apiReturns: { fontSize: '13px', color: '#555', lineHeight: 1.5 },
  code: { fontFamily: '"SF Mono", Consolas, Monaco, monospace', background: '#f0f0f0', padding: '2px 6px', borderRadius: '4px', fontSize: '12px', color: '#0E7BB5' },
  techGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' },
  techCard: { background: 'rgba(255,255,255,0.1)', borderRadius: '8px', padding: '20px', borderLeft: '3px solid #FFB800' },
  techCat: { fontSize: '12px', fontWeight: 700, color: '#FFB800', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '8px' },
  techItems: { fontSize: '14px', color: 'rgba(255,255,255,0.85)', lineHeight: 1.6 },
  ctaSection: { padding: '64px 24px', background: '#f8f9fa', textAlign: 'center' },
  ctaBtns: { display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap', marginTop: '8px' },
  btnPrimary: { background: '#0E7BB5', color: '#fff', textDecoration: 'none', padding: '12px 28px', borderRadius: '6px', fontSize: '14px', fontWeight: 600 },
  btnOutline: { background: 'transparent', color: '#0E7BB5', textDecoration: 'none', padding: '12px 28px', borderRadius: '6px', fontSize: '14px', fontWeight: 600, border: '1.5px solid #0E7BB5' },
}